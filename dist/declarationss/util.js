...
export const convertToStringArray = (maybeArray) => {
    if (Array.isArray(maybeArray)) {
        return maybeArray;
    }
    return [maybeArray];
};
export const formatDayOfTheWeek = (locale, date, format) => {
    return capitalize(new Intl.DateTimeFormat(locale, { weekday: format }).format(date));
};
export const getDaysOfTheWeek = (locale, weekStart) => {
...
const getDayOfTheWeekObject = (locale, date) => {
    return {
...
export const getDisplayMonth = (calendarDisplayMonth, locale) => {
    return capitalize(new Intl.DateTimeFormat(locale, { month: 'long' }).format(calendarDisplayMonth.date));
};
export const getDisplayYear = (calendarDisplayMonth) => calendarDisplayMonth.getFullYear();
export const getNewDisplayTimePeriods = (newTimePeriod) => {
...
export const prependZeroes = (value, length) => {
